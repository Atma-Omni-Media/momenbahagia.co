  ...
  <body>
    ...
    <footer class="fdb-block footer-small footer">
        ...
        <div class="col-12 text-lg-left">
            ...
            <div class="col">
                <p class="text-footer" style="color:#fff;">&#169;2021 <a href="<?php echo base_url() ?>" rel="dofollow" target="_blank"><?= SITE_NAME ?></a> - <a href="https://lakonlab.com" rel="dofollow" target="_blank">LakonLab</a> - <a href="https://401xd.com" rel="dofollow" target="_blank">AtmaOmniMedia</a>.</p>
            </div>
            </div>
        </div>
    </footer>
