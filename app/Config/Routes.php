...
if(isset($_SERVER['HTTP_HOST'])){
	...
	$routes->post('/undangan/add_komentar', 'Undangan::do_add_komentar');
	$routes->add('/undangan/(:any)', 'Undangan::Undangan');
	
/* =================== UNTUK ADMIN PANEL ======================= */		

	$routes->setDefaultNamespace('App\Controllers\admin');
	// $routes->setDefaultController('Admin');
	$routes->add('administrator/admin', 'Admin::dashboard');
	$routes->add('administrator/admin/dashboard', 'Admin::dashboard');
	$routes->add('administrator/admin/pembayaran', 'Admin::pembayaran');
	$routes->add('administrator/admin/profil', 'Admin::profil');
	$routes->add('administrator/admin/setting', 'Admin::setting');
	$routes->get('administrator/login', 'Admin::login');
	$routes->add('administrator/admin/edit_pengguna', 'Admin::edit_pengguna');
	$routes->add('administrator/admin/pengguna', 'Admin::pengguna');

	$routes->add('administrator/logout', 'Admin::do_unauth');
	$routes->post('administrator/do_auth', 'Admin::do_auth');
	$routes->post('administrator/admin/update_setting', 'Admin::do_update_setting');
	$routes->post('administrator/admin/update_admin', 'Admin::do_update_admin');
	$routes->post('administrator/admin/konfirmasi', 'Admin::do_konfirmasi');
	$routes->post('administrator/admin/hapus_user', 'Admin::do_hapus_user');
	$routes->post('administrator/admin/update_fitur', 'Admin::do_update_fitur');
	$routes->post('administrator/admin/update_domain', 'Admin::do_update_domain');
	$routes->post('administrator/admin/update_foto_mempelai', 'Admin::do_update_foto_mempelai');
	$routes->post('administrator/admin/update_mempelai', 'Admin::do_update_mempelai');
	$routes->post('administrator/admin/update_acara', 'Admin::do_update_acara');
	$routes->post('administrator/admin/update_maps', 'Admin::do_update_maps');
	$routes->post('administrator/admin/update_gallery', 'Admin::do_update_gallery');
	$routes->post('administrator/admin/del_gallery', 'Admin::do_del_gallery');
	$routes->post('administrator/admin/update_cerita', 'Admin::do_update_cerita');
